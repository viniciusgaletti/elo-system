...
export function LancamentoBottomBar({ canComplete, onSaveDraft, onComplete }: Props) {
  ...
  return (
    <>
      ...
      <Dialog open={showConfirm} onOpenChange={setShowConfirm}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Concluir Lançamento?</DialogTitle>
            <DialogDescription>
              Ao concluir, você finalizará o planejamento de ferramentas. Você ainda poderá editar
              as soluções.
            </DialogDescription>
          </DialogHeader>
